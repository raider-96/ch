...
function getPresetUsers() {
  ...
  for (let i = 1; i <= 20; i++) {
    users.push({
      id: 'u' + i,
      username: i === 1 ? '1' : '2' + String(i).padStart(2, '0'),
      password: i === 1 ? '1' : '2',
      active: true,
      usedQuestions: []
    });
...
var realMadrid = { id: 'real_madrid_01',name: 'ريال مدريد', icon: '👑', qs: [
        // سهل
        {id:'rm1', text:'ما هو اللقب الشهير لنادي ريال مدريد؟', options:['البلوغرانا', 'الميرينغي', 'الريدز', 'السييدز'], correctIndex:1, difficulty:'easy', points:100 },
        {id:'rm2', text:'ما اسم ملعب نادي ريال مدريد الرسمي؟', options:['كامب نو', 'سان سيرو', 'سانتياغو برنابيو', 'واندا ميتروبوليتانو'], correctIndex:2, difficulty:'easy', points:100 },
        {id:'rm3', text:'من هو الهداف التاريخي لنادي ريال مدريد؟', options:['راؤول غونزاليس', 'كريم بنزيما', 'كريستيانو رونالدو', 'ألفريدو دي ستيفانو'], correctIndex:2, difficulty:'easy', points:100 },
        {id:'rm4', text:'كم عدد بطولات ريال مدريد في دوري أبطال أوروبا (حتى 2024)؟', options:['10', '13', '15', '14'], correctIndex:2, difficulty:'easy', points:100 },
        {id:'rm5', text:'ما هو اللون الأساسي لطقم ريال مدريد؟', options:['الأزرق', 'الأبيض', 'الأحمر', 'الأسود'], correctIndex:1, difficulty:'easy', points:100 },
        {id:'rm6', text:'من هو اللاعب الملقب بـ "الدون" الذي لعب للريال؟', options:['زيدان', 'رونالدو البرازيلي', 'كريستيانو رونالدو', 'بيل'], correctIndex:2, difficulty:'easy', points:100 },
        {id:'rm7', text:'أي مدينة ينتمي إليها نادي ريال مدريد؟', options:['برشلونة', 'مدريد', 'إشبيلية', 'فالنسيا'], correctIndex:1, difficulty:'easy', points:100 },
        {id:'rm8', text:'من كان مدرب الفريق في ثلاثية دوري الأبطال المتتالية (2016-2018)؟', options:['أنشيلوتي', 'مورينيو', 'زين الدين زيدان', 'بينيتيز'], correctIndex:2, difficulty:'easy', points:100 },
        {id:'rm9', text:'ما اسم المواجهة التاريخية بين ريال مدريد وبرشلونة؟', options:['ديربي مدريد', 'الكلاسيكو', 'كلاسيكو إنجلترا', 'مباراة الموسم'], correctIndex:1, difficulty:'easy', points:100 },
        {id:'rm10', text:'من هو القائد التاريخي الذي كان يرتدي الرقم 4 ورحل إلى باريس؟', options:['كاسياس', 'سيرجيو راموس', 'مارسيلو', 'ببيي'], correctIndex:1, difficulty:'easy', points:100 },
        {id:'rm11', text:'من هو الحارس الذي لقب بـ "القديس" في مدريد؟', options:['كورتوا', 'كيلور نافاس', 'إيكر كاسياس', 'دييغو لوبيز'], correctIndex:2, difficulty:'easy', points:100 },
        {id:'rm12', text:'كم عدد تبديلات "الجالاكتيكوس" الشهيرة التي ضمت فيغو وزيدان؟', options:['الأولى', 'الثانية', 'الثالثة', 'الرابعة'], correctIndex:0, difficulty:'easy', points:100 },
        {id:'rm13', text:'أي من هؤلاء اللاعبين فاز بالكرة الذهبية مع الريال في 2022؟', options:['مودريتش', 'فينيسيوس', 'كريم بنزيما', 'كروس'], correctIndex:2, difficulty:'easy', points:100 },
        {id:'rm14', text:'ما هو رقم قميص اللاعب فينيسيوس جونيور الحالي؟', options:['20', '11', '7', '10'], correctIndex:2, difficulty:'easy', points:100 },
        {id:'rm15', text:'من هو رئيس نادي ريال مدريد الحالي؟', options:['فلورنتينو بيريز', 'رامون كالديرون', 'سانتياغو برنابيو', 'لابورتا'], correctIndex:0, difficulty:'easy', points:100 },
        {id:'rm16', text:'ما هو لقب ديربي مدينة مدريد ضد أتلتيكو؟', options:['ديربي الغضب', 'ديربي العاصمة', 'ديربي مدريد', 'ديربي الشمس'], correctIndex:2, difficulty:'easy', points:100 },
        {id:'rm17', text:'أي لاعب فرنسي أسطوري سجل هدف الفوز في نهائي 2002؟', options:['هنري', 'زيدان', 'بنزيمة', 'مبامبي'], correctIndex:1, difficulty:'easy', points:100 },
        {id:'rm18', text:'في أي قارة يقع نادي ريال مدريد؟', options:['آسيا', 'أفريقيا', 'أوروبا', 'أمريكا'], correctIndex:2, difficulty:'easy', points:100 },
        {id:'rm19', text:'ما اسم النشيد الرسمي للنادي؟', options:['هلا مدريد', 'ليفا مدريد', 'عاش مدريد', 'مدريد فقط'], correctIndex:0, difficulty:'easy', points:100 },
        {id:'rm20', text:'من هو اللاعب الكرواتي الذي فاز بالكرة الذهبية 2018؟', options:['راكيتيتش', 'لوكا مودريتش', 'كوفاسيتش', 'ماندزوكيتش'], correctIndex:1, difficulty:'easy', points:100 },
        // المتوسط
        {id:'rm21', text:'من هو اللاعب الذي سجل هدف "العاشرة" القاتل في الدقيقة 92:48؟', options:['بيل', 'رونالدو', 'سيرجيو راموس', 'دي ماريا'], correctIndex:2, difficulty:'medium', points:200 },
        {id:'rm22', text:'كم مرة فاز ريال مدريد بالدوري الإسباني (حتى موسم 2023-24)؟', options:['30', '33', '36', '32'], correctIndex:2, difficulty:'medium', points:200 },
        {id:'rm23', text:'من هو اللاعب الملقب بـ "الصاروخ" (The Welsh Wizard)؟', options:['مودريتش', 'غاريث بيل', 'مايكل أوين', 'بيكهام'], correctIndex:1, difficulty:'medium', points:200 },
        {id:'rm24', text:'في أي عام تأسس نادي ريال مدريد؟', options:['1900', '1902', '1899', '1905'], correctIndex:1, difficulty:'medium', points:200 },
        {id:'rm25', text:'من هو المدرب الذي حقق لقب العاشرة (La Decima)؟', options:['مورينيو', 'زيدان', 'أنشيلوتي', 'دل بوسكي'], correctIndex:2, difficulty:'medium', points:200 },
        {id:'rm26', text:'ما هو الرقم الذي كان يرتديه راؤول غونزاليس قبل رونالدو؟', options:['9', '11', '7', '10'], correctIndex:2, difficulty:'medium', points:200 },
        {id:'rm27', text:'من هو اللاعب الإنجليزي الذي انتقل من اليونايتد للريال عام 2003؟', options:['روني', 'ديفيد بيكهام', 'ستيفن جيرارد', 'مايكل أوين'], correctIndex:1, difficulty:'medium', points:200 },
        {id:'rm28', text:'ضد أي فريق فاز ريال مدريد في نهائي أبطال أوروبا 2017؟', options:['ليفربول', 'يوفنتوس', 'أتلتيكو مدريد', 'بايرن ميونخ'], correctIndex:1, difficulty:'medium', points:200 },
        {id:'rm29', text:'ما هي الجنسية الأصلية للاعب ألفريدو دي ستيفانو؟', options:['إسباني', 'أرجنتيني', 'برازيلي', 'برتغالي'], correctIndex:1, difficulty:'medium', points:200 },
        {id:'rm30', text:'من هو المدافع البرازيلي الشهير بصاحب أقوى تسديدات يسارية؟', options:['مارسيلو', 'روبيرتو كارلوس', 'كاسيميرو', 'دانيلو'], correctIndex:1, difficulty:'medium', points:200 },
        {id:'rm31', text:'كم عدد الكرات الذهبية التي حققها كريستيانو رونالدو "مع" الريال؟', options:['5', '3', '4', '2'], correctIndex:2, difficulty:'medium', points:200 },
        {id:'rm32', text:'من هو اللاعب الملقب بـ "المهندس" الذي اعتزل في مدريد 2024؟', options:['مودريتش', 'توني كروس', 'إيسكو', 'خاميس'], correctIndex:1, difficulty:'medium', points:200 },
        {id:'rm33', text:'ما اسم المنطقة التي يحتفل فيها جمهور الريال بالبطولات؟', options:['ساحة الكتالونيا', 'ساحة السيبيليس', 'نيبتونو', 'بورتو ديل سول'], correctIndex:1, difficulty:'medium', points:200 },
        {id:'rm34', text:'من هو اللاعب الذي سجل "هاتريك" في نهائي أبطال أوروبا ضد آينتراخت 1960؟', options:['دي ستيفانو', 'بوشكاش', 'خينتو', 'راؤول'], correctIndex:1, difficulty:'medium', points:200 },
        {id:'rm35', text:'كم عدد بطولات دوري الأبطال التي فاز بها زيدان كـ "لاعب" مع الريال؟', options:['1', '2', '3', '0'], correctIndex:0, difficulty:'medium', points:200 },
        {id:'rm36', text:'أي فريق واجهه الريال في "نهائي القرن" بكأس ملك إسبانيا 2002؟', options:['برشلونة', 'ديبورتيفو لاكورونيا', 'فالنسيا', 'مايوركا'], correctIndex:1, difficulty:'medium', points:200 },
        {id:'rm37', text:'من هو اللاعب الأكثر مشاركة في تاريخ النادي؟', options:['كاسياس', 'راؤول غونزاليس', 'سانتشيز', 'راموس'], correctIndex:1, difficulty:'medium', points:200 },
        {id:'rm38', text:'من هو المدرب الملقب بـ "The Special One" الذي درب الريال؟', options:['أنشيلوتي', 'جوارديولا', 'جوزيه مورينيو', 'بليغريني'], correctIndex:2, difficulty:'medium', points:200 },
        {id:'rm39', text:'ما هي نتيجة أكبر فوز للريال على برشلونة تاريخياً؟', options:['5-0', '11-1', '6-2', '8-2'], correctIndex:1, difficulty:'medium', points:200 },
        {id:'rm40', text:'من هو اللاعب الذي يلقب بـ "الشيخ" أو الفتى الذهبي لوسط الميدان؟', options:['فالفيردي', 'تشواميني', 'مودريتش', 'كامافينجا'], correctIndex:2, difficulty:'medium', points:200 },
        //الصعب
        {id:'rm41', text:'من هو اللاعب الوحيد الذي فاز بـ 6 كؤوس أوروبية (دوري أبطال)؟', options:['رونالدو', 'باكو خينتو', 'مودريتش', 'كروس'], correctIndex:1, difficulty:'hard', points:400 },
        {id:'rm42', text:'ما كان اسم النادي قبل أن يمنحه الملك لقب "ريال" عام 1920؟', options:['كاستيا مدريد', 'مدريد فوتبول كلوب', 'إسبانيول مدريد', 'أتلتيك مدريد'], correctIndex:1, difficulty:'hard', points:400 },
        {id:'rm43', text:'من كان مدرب ريال مدريد عندما فاز بالخماسية الأوروبية الأولى؟', options:['ميغيل مونيوز', 'خوسيه فيالونغا', 'دل بوسكي', 'سانتياغو برنابيو'], correctIndex:1, difficulty:'hard', points:400 },
        {id:'rm44', text:'في أي ملعب فاز ريال مدريد بأول لقب دوري أبطال أوروبا (1956)؟', options:['بارك دي برينس', 'ويمبلي', 'الأوليمبيكو', 'سان سيرو'], correctIndex:0, difficulty:'hard', points:400 },
        {id:'rm45', text:'ما هو اسم مجموعة اللاعبين الخمسة الذين سيطروا على الكرة الإسبانية في الثمانينيات؟', options:['الجالاكتيكوس', 'خماسي النسر (Quinta del Buitre)', 'الروكوس', 'البيبيس'], correctIndex:1, difficulty:'hard', points:400 },
        {id:'rm46', text:'من هو اللاعب الذي سجل هدف الفوز في نهائي دوري الأبطال 1998 ضد يوفنتوس؟', options:['راؤول', 'مياتوفيتش', 'سوكر', 'ريدوندو'], correctIndex:1, difficulty:'hard', points:400 },
        {id:'rm47', text:'كم سنة قضاها سانتياغو برنابيو رئيساً للنادي؟', options:['20 سنة', '35 سنة', '10 سنوات', '15 سنة'], correctIndex:1, difficulty:'hard', points:400 },
        {id:'rm48', text:'من هو اللاعب الذي فاز بجائزة "الكرة الذهبية الفائقة" (Super Ballon d’Or)؟', options:['رونالدو', 'زيدان', 'دي ستيفانو', 'بوشكاش'], correctIndex:2, difficulty:'hard', points:400 },
        {id:'rm49', text:'من هو أصغر لاعب سجل للريال في دوري الأبطال؟', options:['راؤول غونزاليس', 'رودريغو', 'فينيسيوس', 'بيلينجهام'], correctIndex:0, difficulty:'hard', points:400 },
        {id:'rm50', text:'أي من هؤلاء اللاعبين لم يلعب "أبداً" لريال مدريد؟', options:['صامويل إيتو', 'لويس فيغو', 'رونالدينيو', 'مايكل أوين'], correctIndex:2, difficulty:'hard', points:400 },
        {id:'rm51', text:'من هو اللاعب الملقب بـ "الرأس الذهبية" في تاريخ مدريد؟', options:['سانتيانا', 'راموس', 'بنزيمة', 'زامورانو'], correctIndex:0, difficulty:'hard', points:400 },
        {id:'rm52', text:'كم عدد الأهداف التي سجلها كريستيانو رونالدو رسمياً مع النادي؟', options:['450', '438', '500', '410'], correctIndex:0, difficulty:'hard', points:400 },
        {id:'rm53', text:'من هو الحارس الذي استقبل أقل عدد أهداف في موسم واحد وحقق زامورا؟', options:['كورتوا', 'كاسياس', 'باكو بويو', 'نافاس'], correctIndex:2, difficulty:'hard', points:400 },
        {id:'rm54', text:'ما هي الدولة التي استضافت نهائي "العاشرة"؟', options:['إسبانيا', 'البرتغال', 'إيطاليا', 'ألمانيا'], correctIndex:1, difficulty:'hard', points:400 },
        {id:'rm55', text:'من هو الشريك التاريخي لدي ستيفانو في الهجوم (مجري الجنسية)؟', options:['كوبالا', 'بوشكاش', 'كوكسيس', 'ساندور'], correctIndex:1, difficulty:'hard', points:400 },
        {id:'rm56', text:'أي لاعب كان يرتدي الرقم 5 قبل جود بيلينجهام وزيدان؟', options:['هييرو', 'كانافارو', 'مانويل سانشيز', 'ريدوندو'], correctIndex:2, difficulty:'hard', points:400 },
        {id:'rm57', text:'من هو المدرب الذي تمت إقالته بعد الفوز بدوري الأبطال مباشرة عام 2003؟', options:['فيسنتي دل بوسكي', 'كيروش', 'كابيلو', 'هاينكس'], correctIndex:0, difficulty:'hard', points:400 },
        {id:'rm58', text:'في أي عام تم افتتاح ملعب سانتياغو برنابيو لأول مرة؟', options:['1940', '1947', '1950', '1938'], correctIndex:1, difficulty:'hard', points:400 },
        {id:'rm59', text:'من هو اللاعب الأرجنتيني الذي كان يلقب بـ "إل برينسيب" (الأمير) في التسعينيات؟', options:['ريدوندو', 'فالدانو', 'هيغواين', 'دي ماريا'], correctIndex:0, difficulty:'hard', points:400 },
        {id:'rm60', text:'ما هو الفريق الذي خسر أمام الريال في أول نهائي كؤوس أوروبية للشباب؟', options:['بنفيكا', 'برشلونة', 'مانشستر سيتي', 'يوفنتوس'], correctIndex:0, difficulty:'hard', points:400 }
]};
data.categories.push({ id: realMadrid.id, name: realMadrid.name, icon: realMadrid.icon, questions: prepQuestions(realMadrid.qs) });
